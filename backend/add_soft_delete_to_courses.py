...
async def add_soft_delete_columns_to_courses():
    ...
    try:
        ...
        SELECT column_name 
        FROM information_schema.columns 
        WHERE table_name = 'courses' AND column_name = 'deleted_by'
        """
        ...
        print("\n✅ Soft delete columns added to courses table successfully!")
...
if __name__ == "__main__":
    asyncio.run(add_soft_delete_columns_to_courses())
